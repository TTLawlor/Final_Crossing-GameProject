...
local function fireTurret1()
      ...
      laser15 = display.newImageRect("laser.png", 20, 10 )
      bulletGroup:insert( laser15 )
      physics.addBody( laser15,  "static")
      laser15.gravityScale = 0
      laser15.isBullet = applyTorque
      ...
      laser15.x = turret15.x
      laser15.y = turret15.y

      transition.to( laser1, { y=700, time=500, onComplete = function() display.remove( laser1 ) end} )
      transition.to( laser5,  { x=585, time=400, onComplete = function() display.remove( laser5 ) end} )
      transition.to( laser8,  { y=20, time=1000, onComplete = function() display.remove( laser8 ) end} )
      transition.to( laser10,  { y=670, time=1000, onComplete = function() display.remove( laser10 ) end} )
      transition.to( laser12,  { x=950, time=800, onComplete = function() display.remove( laser12 ) end} )
      transition.to( laser15,  { x=1750, time=1000, onComplete = function() display.remove( laser15 ) end} )
...
local function fireTurret2()
      ...
      laser6 = display.newImageRect("laser.png", 20, 10 )
      ...
      transition.to( laser6,  { x=580, time=900, onComplete = function() display.remove( laser6 ) end} )
      transition.to( laser9,  { y=670, time=800, onComplete = function() display.remove( laser9 ) end} )
...
local function fireTurret3()
      ...
      transition.to( laser7,  { y=200, time=800, onComplete = function() display.remove( laser7 ) end} )
      transition.to( laser11,  { x=20, time=1400, onComplete = function() display.remove( laser11 ) end} )
      transition.to( laser14,  { x=1595, time=700, onComplete = function() display.remove( laser14 ) end} )
...
function scene:create( event )
  ...
  sensor1.collision = sensorCollideSpikes1
    ...
    turret15 = map:findObject("turret15")
    turret15.myName = "turret15"
