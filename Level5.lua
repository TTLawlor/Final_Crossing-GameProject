...
--feather area
  ...
  transition.to(bullet3, { time = 2500, x = (bullet3.x + 1216), iterations=0, transition = easing.linear})
  bullet3.collision = triggerCollisionDeath

  bullet3half = map:findObject("bullet3half")
  transition.to(bullet3half, { time = 2500, x = (bullet3half.x + 1216), iterations=0, transition = easing.linear, delay = 1250  })
  bullet3half.collision = triggerCollisionDeath
